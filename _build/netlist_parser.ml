...
# 232 "<standard.mly>"
    ( xs )
# 418 "netlist_parser.ml"
              
            in
            let inp = 
# 232 "<standard.mly>"
    ( xs )
# 424 "netlist_parser.ml"
             in
...
# 27 "netlist_parser.mly"
       (string)
# 1084 "netlist_parser.ml"
        ))) = _menhir_stack in
        let _2 = () in
        let _v : (Netlist_ast.ident list) = 
# 243 "<standard.mly>"
    ( x :: xs )
# 1090 "netlist_parser.ml"
         in
...
# 27 "netlist_parser.mly"
       (string)
# 1291 "netlist_parser.ml"
        ))) = _menhir_stack in
        let _v : (Netlist_ast.ident list) = 
# 241 "<standard.mly>"
    ( [ x ] )
# 1296 "netlist_parser.ml"
         in
        _menhir_goto_separated_nonempty_list_COMMA_NAME_ _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
